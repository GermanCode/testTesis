...
const Network = require('./network.js'); //prueba 12/02/2021 funcinality modular and dinamic learning


console.log('Digite el numero de Variables');
const numVars = 2;
console.log('Usted a digitado el numero ' + numVars + '.'); // Define the layer structure
